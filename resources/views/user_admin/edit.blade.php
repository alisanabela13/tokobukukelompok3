                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            Username*
                                            <input type="text" class="form-control @error('username') is-invalid @enderror" required name="username" placeholder="{{$user->username}}" >
                                            @error('username')
                                            ...
                                            <br/>
                                            E-Mail*
                                            <input type="text" class="form-control @error('email') is-invalid @enderror" required name="email" placeholder="{{$user->email}}" >
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
